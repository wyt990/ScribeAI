...
export const SETTING_DEFINITIONS: SettingDef[] = [
  ...
  { key: 'storage.stale_threshold_minutes', group: 'storage', envKey: 'STALE_THRESHOLD_MINUTES', label: '过期上传阈值(分)', defaultValue: '30' },
  { key: 'storage.cleanup_interval_minutes', group: 'storage', envKey: 'CLEANUP_INTERVAL_MINUTES', label: '清理间隔(分)', defaultValue: '15' },

...
export const SETTING_DEFINITIONS: SettingDef[] = [
  ...
  {
    key: 'mobile.show_audio_enhancement_panel',
    group: 'mobile',
    envKey: 'SHOW_AUDIO_ENHANCEMENT_PANEL',
    label: '显示录音页音频增强面板',
    defaultValue: 'true',
  },
  {
    key: 'mobile.audio_gain_min',
    group: 'mobile',
    envKey: 'AUDIO_GAIN_MIN',
    label: '增益下限（0=可静音）',
    defaultValue: '0',
  },
  {
    key: 'mobile.audio_gain_max',
    group: 'mobile',
    envKey: 'AUDIO_GAIN_MAX',
    label: '增益上限',
    defaultValue: '3',
  },
  {
    key: 'mobile.audio_gain_step',
    group: 'mobile',
    envKey: 'AUDIO_GAIN_STEP',
    label: '增益滑条步进',
    defaultValue: '0.2',
  },
  {
    key: 'mobile.audio_gain_default',
    group: 'mobile',
    envKey: 'AUDIO_GAIN_DEFAULT',
    label: '默认增益（1=不增不减）',
    defaultValue: '1',
  },
  {
    key: 'mobile.native_chunk_mode',
    group: 'mobile',
    envKey: 'NATIVE_CHUNK_MODE',
    label: '原生分片模式',
    defaultValue: 'auto',
  },
  {
    key: 'mobile.native_chunk_seconds',
    group: 'mobile',
    envKey: 'NATIVE_CHUNK_SECONDS',
    label: '原生定时节间隔(秒，timer模式)',
    defaultValue: '3',
  },
  {
    key: 'mobile.native_vad_rms_threshold',
    group: 'mobile',
    envKey: 'NATIVE_VAD_RMS_THRESHOLD',
    label: '原生静音分句 RMS 阈值(auto模式)',
    defaultValue: '0.02',
  },
